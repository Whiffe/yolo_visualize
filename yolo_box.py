...
parser.add_argument('--txt', default='./temp/1.txt',type=str)
parser.add_argument('--img', default='./temp/1.jpg',type=str)
parser.add_argument('--save', default='./temp/1_1.jpg',type=str)
...
image_path = arg.img
save_path = arg.save
#label_path = r'./temp/1.txt'
#image_path = r'./temp/1.jpg'
